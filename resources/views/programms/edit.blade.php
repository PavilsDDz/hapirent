...
@section('content')
    ...
    <form method="post" class="paddingH1 delete_form" action="{{url('/')}}/programms">
        @csrf
        
        {{ method_field('delete') }}
        <button type="submit" value="{{$program['id']}}" class="delete" name="id">delete</button>
    </form>
    <form action="{{url('/')}}/programms/{{$program['id']}}" id="edit_from" method="POST">
        @csrf
        @method('put')
            ...
            <div class="">
                ...
                <div class="flex sb paddingH1">
                  <div class="input flex column column2">
                    ...
                    <input id="shortDisc_lv_input" type="hidden" name="shortDisc_lv" value="{{addslashes($program['shortDisc_lv'])}}">
                  </div>
                  <div class="input flex column column2">
                   <label for="title_ru">{{trans('lang.title')}} ru:</label> <input id="title_lv" type="text" value="{{$program['title_ru']}}" name="title_ru">
                    ...
                    <input id="shortDisc_ru_input" type="hidden" name="shortDisc_ru" value="{{addslashes($program['shortDisc_ru'])}}">
                  </div>
                </div>
                ...
                <input type="hidden" value="{{addslashes($program['description_lv'])}}" name="description_lv" id="description_lv">
                <!-- <input type="text" value="{{$program['title_ru']}}" name="title_ru"> -->
                <input type="hidden" value="{{addslashes($program['description_ru'])}}" name="description_ru" id="description_ru">
...
@section('scripts_bottom')
    ...
    <script>
        $(function(){
            ...
            $('#edit').froalaEditor('html.set','{!!addslashes($program["description_lv"])!!}')
            $('#shortDisc_lv').froalaEditor('html.set','{!!addslashes($program["shortDisc_lv"])!!}')
            $('#shortDisc_ru').froalaEditor('html.set','{!!addslashes($program["shortDisc_ru"])!!}')
        });
    </script>
