        ...
        <div class="paddingV1">
            ...
            <div class="flex paddingH1 sb">
              <div class="input flex column column2">
               <label for="gallery_title_lv">{{trans('lang.title')}} Lv:</label><input type="text" name="title_lv" >
              </div>
              <div class="input flex column column2">
               <label for="gallery_title_ru">{{trans('lang.title')}} Ru:</label> <input type="text" name="title_ru">
              </div>
            </div>
            ...
            <input type="hidden" value="" name="description_ru" id="description_ru">
                <div>
                    <span for="datepicker">{{trans('lang.date')}}</span>
                </div>
             <div class="input flex paddingH1 datetime_input">
                ...
                <input type="number" value="01" name="day">
